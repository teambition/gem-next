...
import { RecordQuery, RecordQueryBll, ScanQuery } from '../interface/record-query'
...
export class RecordBllImpl implements RecordStorageBll, RecordQueryBll<any, any> {
  ...
  async scan(query: ScanQuery): Promise<AsyncIterable<RecordData>> {
    return this.recordQueryBll.scan(query)
  }
}
