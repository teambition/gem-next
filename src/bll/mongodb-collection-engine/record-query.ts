...
import { RecordQueryBll, RecordQuery, RecordAggregateByPatchSort, RecordGroup, Sort, FindByIdQuery } from '../../interface/record-query'
...
export class MongodbCollectionRecordQueryBllImpl implements RecordQueryBll<any, any> {
  ...
  async findById({ id, limit, skip = 0, options = {} }: FindByIdQuery): Promise<AsyncIterable<RecordData>> {
